let e={data:{currentGame:{computerPlay:"",myPlay:""},history:[]},listeners:[],getState(){return this.data},setState(e){for(let t of(this.data=e,this.listeners))t();localStorage.setItem("ppt-history",JSON.stringify(this.data.history))},subscribe(e){this.listeners.push(e)},init(){let e=localStorage.getItem("ppt-history");if(e&&"undefined"!==e)try{let t=JSON.parse(e),a=this.getState();this.setState({...a,history:t})}catch(e){console.error("Error recuperando localStorage",e)}},setMove(e){let t=this.getState();t.currentGame.myPlay=e,this.data=t},pushToHistory(){let e=this.getState(),t=e.currentGame.myPlay,a=["piedra","papel","tijera"][Math.floor(3*Math.random())];e.currentGame.computerPlay=a;let n=this.whoWins(t,a),i=e.history||[];i.push({myPlay:t,computerPlay:a,winner:n}),this.setState({...e,history:i})},whoWins:(e,t)=>e===t?"empate":"tijera"===e&&"papel"===t||"piedra"===e&&"tijera"===t||"papel"===e&&"piedra"===t?"yo":"computadora",getScore(){let e=this.getState(),t=0,a=0;return(e.history||[]).forEach(e=>{"yo"===e.winner&&t++,"computadora"===e.winner&&a++}),{yo:t,computadora:a}}};e.init();var t={};t=import.meta.resolve("Ujjrq");class a extends HTMLElement{connectedCallback(){this.render()}render(){this.innerHTML=`
    ...
    `,this.appendChild(a),setTimeout(()=>{this.goTo("/results")},2500)}}customElements.define("play-page",o);var r={};r=import.meta.resolve("lpCOD");var s={};s=import.meta.resolve("78Fzp");var l={};l=import.meta.resolve("bO0WC");var c={};c=import.meta.resolve("iSRbA");var d={};d=import.meta.resolve("aV8qR");var m={};m=import.meta.resolve("kOwh6");class p extends HTMLElement{connectedCallback(){this.render()}render(){let t=e.getState().currentGame,a=e.whoWins(t.myPlay,t.computerPlay),n=e.getScore(),i="yo"===a,o=i?r:s,p=i?l:c,h=i?d:m;this.innerHTML=`
...
//# sourceMappingURL=desafio-ppt.c435f33e.js.map
