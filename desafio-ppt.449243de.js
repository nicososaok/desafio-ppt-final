let e={data:{currentGame:{computerPlay:"",myPlay:""},history:[]},listeners:[],getState(){return this.data},setState(e){for(let t of(this.data=e,this.listeners))t();localStorage.setItem("ppt-history",JSON.stringify(this.data.history))},subscribe(e){this.listeners.push(e)},init(){let e=localStorage.getItem("ppt-history");if(e&&"undefined"!==e)try{let t=JSON.parse(e),a=this.getState();this.setState({...a,history:t})}catch(e){console.error("Error recuperando localStorage",e)}},setMove(e){let t=this.getState();t.currentGame.myPlay=e,this.data=t},pushToHistory(){let e=this.getState(),t=e.currentGame.myPlay,a=["piedra","papel","tijera"][Math.floor(3*Math.random())];e.currentGame.computerPlay=a;let i=this.whoWins(t,a),n=[...e.history||[],{myPlay:t,computerPlay:a,winner:i}];this.setState({...e,history:n})},whoWins:(e,t)=>e===t?"empate":"tijera"===e&&"papel"===t||"piedra"===e&&"tijera"===t||"papel"===e&&"piedra"===t?"yo":"computadora",getScore(){let e=this.getState(),t=0,a=0;return(e.history||[]).forEach(e=>{"yo"===e.winner&&t++,"computadora"===e.winner&&a++}),{yo:t,computadora:a}}};e.init();var t={};t=import.meta.resolve("Ujjrq");class a extends HTMLElement{connectedCallback(){this.render()}render(){this.innerHTML=`
    ...
    `;let e=document.createElement("style");e.textContent=`
      ...
      .instructions-hands {
        ...
        gap: 20px; width: 100%; height: 20vh;
      }
      my-jugada { width: 65px; }
      @media (max-height: 700px) {
        .instructions-image-container { max-width: 220px; }
        .start-game-btn { height: 60px; }
      }
    ...
    `;let e=document.createElement("style");e.textContent=`
      ...
      .countdown-wrapper {
        position: relative;
        width: 25vh; /* Basado en el alto de pantalla */
        height: 25vh;
        display: flex;
        justify-content: center;
        align-items: center;
      ...
      .number { font-size: 10vh; font-weight: bold; }
      .play__hands {
        display: flex;
        justify-content: center;
        align-items: flex-end;
      ...
      .hand-btn { width: 75px; transition: all 0.2s; }
      .duel-screen {
      ...
      .hand-pc { transform: rotate(180deg); width: 130px; }
      .hand-user { width: 130px; margin-bottom: 40px; } /* Subimos la mano del usuario */

      @media (max-width: 768px) {
        .countdown-wrapper { width: 180px; height: 180px; }
        .number { font-size: 70px; }
        .play__hands { height: 180px; gap: 10px; }
        .hand-btn { width: 70px; }
      }
    `,this.appendChild(e),this.startCountdown()}startCountdown(){let t=this.querySelector(".number"),a=3,i=!1;this.querySelectorAll(".hand-btn").forEach(t=>{t.addEventListener("click",()=>{let a=t.getAttribute("jugada");e.setMove(a),i=!0,this.querySelectorAll(".hand-btn").forEach(e=>{e!==t?e.style.filter="grayscale(1) opacity(0.4)":(e.style.filter="none",e.style.transform="translateY(-20px) scale(1.1)")})})});let n=setInterval(()=>{if(a--,t&&(t.textContent=a.toString()),a<=0)if(clearInterval(n),i){e.pushToHistory();let{myPlay:t,computerPlay:a}=e.getState().currentGame;this.showConfrontation(t,a)}else this.goTo("/instructions")},1e3)}showConfrontation(e,t){this.innerHTML=`
    ...
    `;let a=document.createElement("style");a.textContent=`
      ...
      my-jugada { display: block; height: 40vh; }
      @media (max-width: 768px) {
        .hand-pc, .hand-user { width: 120px; }
      }
    `,this.appendChild(a),setTimeout(()=>this.goTo("/results"),2500)}}customElements.define("play-page",s);var o={};o=import.meta.resolve("lpCOD");var r={};r=import.meta.resolve("78Fzp");var l={};l=import.meta.resolve("bO0WC");var d={};d=import.meta.resolve("iSRbA");var c={};c=import.meta.resolve("aV8qR");var h={};h=import.meta.resolve("kOwh6");class p extends HTMLElement{connectedCallback(){this.render()}render(){let t=e.getState().currentGame,a=e.whoWins(t.myPlay,t.computerPlay),i=e.getScore(),n="yo"===a,s=n?o:r,p=n?l:d,m=n?c:h;this.innerHTML=`
    ...
    `,this.appendChild(a)}}customElements.define("my-jugada",y),e.init();let f=document.querySelector("#root");if(f){function b(e){window.location.hash=e}function w(e){console.log("El router recibió la ruta (hash):",e);let t=e.replace("#",""),a=!1;for(let e of m)if(e.path.test(t)){a=!0;let t=e.component({goTo:b});f.firstChild&&f.firstChild.remove(),f.appendChild(t);break}a||"/"!==t&&""!==t||b("/welcome")}window.addEventListener("hashchange",()=>{w(window.location.hash)}),window.location.hash?w(window.location.hash):w("#/welcome")}else console.error("No se encontró el elemento #root en el HTML. Revisa tu index.html.");
//# sourceMappingURL=desafio-ppt.449243de.js.map
